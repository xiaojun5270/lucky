...
export default function LoginScreen() {
  ...
  const fieldStyle = { minHeight: 48, backgroundColor: colors.mutedCard, borderRadius: 8, paddingLeft: 44, paddingRight: 13, paddingVertical: 12, color: colors.text, fontSize: 16 } as const;
  ...
  return <SafeAreaView style={{ flex: 1, backgroundColor: colors.page }}><ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', padding: 22 }}>
    <View style={{ width: Math.min(440, Math.max(0, viewport.width - 44)), alignSelf: 'center', gap: 24 }}>
      ...
      <View style={{ gap: 15, padding: 18, borderRadius: 8, backgroundColor: colors.card, borderWidth: Platform.OS === 'ios' ? 0 : 1, borderColor: colors.border }}>
